...
static QCString getCompoundTypeString(SrcLangExt lang,ClassDef::CompoundType compType,bool isJavaEnum)
{
  ...
  else
  {
    switch (compType)
    {
      ...
      case ClassDef::Module:    return "module";
      case ClassDef::Package:    return "package";
...
CodeSymbolType ClassDefImpl::codeSymbolType() const
{
  switch (compoundType())
  {
    ...
    case Module:    return CodeSymbolType::Module;     break;
    case Package:   return CodeSymbolType::Package;     break;
