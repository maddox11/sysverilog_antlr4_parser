...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class ErrorHandler {
    friend class VerilogPreProcessorTokenManager;
    friend class VerilogPreProcessor;
    protected:
      int error_count;
    public:
  ...
  class VerilogPreProcessorTokenManager;
...
/* JavaCC - OriginalChecksum=6f8db1e042178aac7a55ac90202bfbce (do not edit this line) */
