...
public:
  ...
  enum {
    ...
    RuleSs = 581, RuleUdp_nonansi_declaration = 582, RuleUdp_ansi_declaration = 583, 
    RuleUdp_declaration = 584, RuleUdp_port_list = 585, RuleUdp_declaration_port_list = 586, 
    RuleUdp_port_declaration = 587, RuleUdp_output_declaration = 588, RuleUdp_input_declaration = 589, 
    RuleUdp_reg_declaration = 590, RuleUdp_body = 591, RuleCombinational_body = 592, 
    RuleCombinational_entry = 593, RuleSequential_body = 594, RuleUdp_initial_statement = 595, 
    RuleSequential_entry = 596, RuleSeq_input_list = 597, RuleLevel_input_list = 598, 
    RuleEdge_input_list = 599, RuleEdge_indicator = 600, RuleCurrent_state = 601, 
    RuleNext_state = 602, RuleInit_val = 603, RuleLevel_symbol = 604, RuleOutput_symbol = 605, 
    RuleEdge_symbol = 606, RuleUdp_instantiation = 607, RuleUdp_instance = 608
  };
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_PRIMITIVE();
    SsContext *ss();
    antlr4::tree::TerminalNode *LP();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_ENDPRIMITIVE();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_ENDTABLE();
